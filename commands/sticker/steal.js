...
export default {
    ...
    async execute(xcasper, msg, args, prefix, context) {
        ...
        try {
            ...
            if (!quotedMessage?.stickerMessage && !msg.quoted?.message?.stickerMessage) {
                await xcasper.sendMessage(chatId, { text: "❌ Reply to a sticker first!" }, { quoted: msg });
                return;
            }
            ...
            if (!stickerMessage) {
                await xcasper.sendMessage(chatId, { text: "❌ That's not a sticker!" }, { quoted: msg });
                return;
            }
            ...
            if (!stickerBuffer) {
                await xcasper.sendMessage(chatId, { text: "❌ Failed to download sticker" }, { quoted: msg });
                return;
            }
            ...
            // Just send the sticker - no success message
