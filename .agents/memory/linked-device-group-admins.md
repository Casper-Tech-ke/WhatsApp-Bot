...
**How to apply:** Whenever code decides whether the bot or command sender is a group admin, compare the actual JID, `pn`, `phoneNumber`, and LID fields before denying the action.