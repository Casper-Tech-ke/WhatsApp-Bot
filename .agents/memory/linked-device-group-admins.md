...
The same applies to mentions and quoted group members: resolve a matched LID participant through `phoneNumber` or PN before using it in participant-management actions.
